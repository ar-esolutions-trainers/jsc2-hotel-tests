...
public class TestsReq4 {
    ...
    @Test
    public void f1_4_r1_35() {
        ResponseEntity<PasswordResponse> response = restTemplate.getForEntity(Config.BASE_URL.concat(String.format(RESOURCE, 4, 35)), PasswordResponse.class);

        assertThat(response.getStatusCode(), is(HttpStatus.OK));
        final PasswordResponse respBody = response.getBody();
        assertThat(respBody, is(notNullValue()));
        assertThat(respBody.getPassword(), is("PASS-4-35-45812984491"));
    }
}
